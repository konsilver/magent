...
- 【必须遵循】**如果任务是一个需要生成代码的任务，则你对于“生成代码”的步骤你需要也为他添加“验证代码”的责任，不要特意去做一个“只验证代码”的步骤**
- **complexity 分类规则**：
...
- 低风险任务禁止添加结构性约束
- 【必须遵循】如果这个步骤是需要书写代码的任务，则构造对代码模块的预期执行效果的软约束
- 【必须遵循】如果这个步骤只是“总结/整理”代码，则不要制定“代码验证效果”类约束
