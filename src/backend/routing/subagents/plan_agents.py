...
async def _run_warmup(
    ...
    step_count = len(board.get("plan", {}).get("steps", []))
    logger.info("[Warmup] START user=%s similar_tasks=%d step_count=%d", user_id, len(retrieved_memory.get("similar_tasks", [])), step_count)
